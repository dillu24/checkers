...
type Leaderboard struct {
	Winners string `protobuf:"bytes,1,opt,name=winners,proto3" json:"winners,omitempty"`
}
...
func (m *Leaderboard) GetWinners() string {
	if m != nil {
		return m.Winners
	}
	return ""
...
var fileDescriptor_2f9d046210f4aa4a = []byte{
	...
	0x80, 0x33, 0x94, 0xd4, 0xb9, 0xb8, 0x7d, 0x10, 0xaa, 0x85, 0x24, 0xb8, 0xd8, 0xcb, 0x33, 0xf3,
	0xf2, 0x52, 0x8b, 0x8a, 0x25, 0x18, 0x15, 0x18, 0x35, 0x38, 0x83, 0x60, 0x5c, 0x27, 0x97, 0x13,
	...
	0xd2, 0x4b, 0xce, 0xcf, 0xd5, 0x07, 0x5b, 0xa3, 0x0f, 0x77, 0x48, 0x05, 0x82, 0x59, 0x52, 0x59,
	0x90, 0x5a, 0x9c, 0xc4, 0x06, 0x76, 0x8e, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x23, 0x3c, 0x35,
	0xfa, 0xac, 0x00, 0x00, 0x00,
}
...
func (m *Leaderboard) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Winners) > 0 {
		...
		i = encodeVarintLeaderboard(dAtA, i, uint64(len(m.Winners)))
		i--
		dAtA[i] = 0xa
	}
