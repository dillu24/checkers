...
var (
	...
	cases = []canPlayMoveCase{
		...
		},
		{
			...
			response: nil,
			err:      "game cannot be parsed: invalid board string: *b*b*b*b|b*b*b*b*|*b*b*b*b|",
		},
		{
...
func TestCasesAsExpected(t *testing.T) {
