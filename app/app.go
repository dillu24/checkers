...
import (
	"fmt"
	"github.com/alice/checkers/app/upgrades/v1tov2"
...
type App struct {
	*baseapp.BaseApp
	...
	// The configurator is used only by upgrade handlers
...
func NewApp(
	...
	keys := sdk.NewKVStoreKeys(
		...
		evidencetypes.StoreKey, ibctransfertypes.StoreKey, capabilitytypes.StoreKey, checkersmoduletypes.StoreKey,
